...
// AttunePolicySpec defines the desired state of AttunePolicy.
type AttunePolicySpec struct {
	// TargetRef identifies the workload(s) to be attuned.
...
// AttunePolicyStatus defines the observed state of AttunePolicy.
type AttunePolicyStatus struct {
...
// AttunePolicy is the Schema for the attunepolicies API.
type AttunePolicy struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   AttunePolicySpec   `json:"spec,omitempty"`
	Status AttunePolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AttunePolicyList contains a list of AttunePolicy.
type AttunePolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AttunePolicy `json:"items"`
}

func init() {
	SchemeBuilder.Register(&AttunePolicy{}, &AttunePolicyList{})
}
