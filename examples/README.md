...
| [05-cluster-defaults.yaml](05-cluster-defaults.yaml) | AttuneDefaults CRD with simplified policy | Recommend |
...
| [full-stack/](full-stack/) | Everything needed for one app: namespace, Deployment, ServiceMonitor, AttuneDefaults, AttunePolicy, and Grafana dashboard ConfigMap |
