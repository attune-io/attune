...
*/}}
{{- define "kube-rightsize.fullname" -}}
...
Common labels.
*/}}
{{- define "kube-rightsize.labels" -}}
helm.sh/chart: {{ include "kube-rightsize.chart" . }}
{{ include "kube-rightsize.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels.
*/}}
{{- define "kube-rightsize.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kube-rightsize.name" . }}
...
*/}}
{{- define "kube-rightsize.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kube-rightsize.fullname" .) .Values.serviceAccount.name }}
{{- else }}
