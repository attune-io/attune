...
{{- define "attune.queryServiceAccountName" -}}
{{- if .Values.prometheusAuth.queryServiceAccount.name }}
{{- .Values.prometheusAuth.queryServiceAccount.name }}
{{- else }}
{{- printf "%s-prometheus-query" (include "attune.fullname" .) }}
{{- end }}
{{- end }}
